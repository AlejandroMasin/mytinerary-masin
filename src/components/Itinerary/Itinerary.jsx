...
function Itinerary({ nombre, description, precio, duracion, likes, hashtags, id }) {

    // const cantidadRepeticiones = 3;
    const collapseId = `collapse-${id}`; // Genera un identificador único para el acordeón
            ...
            <div className="card_itinerary">
                ...
                <div className="row">
                    ...
                    {/* <div className="card_itinerary"> */}
                        ...
                        <div className="accordion accordion-flush" id="accordionFlushExample">
                            <div className="accordion-item">
                                <h2 id='itinerary-h2' className="accordion-header">
                                    {/* See more... */}
                                    <button
                                        id={`textp_acordion_${id}`}
                                ...
                                <div id={collapseId} className="accordion-collapse collapse" data-bs-parent={`#${collapseId}`}>
                                    <img src={en_construccion} alt="" />
                                </div>
                            </div>
                        </div>
